...
<div image-carousel id="slider">
	<div>
		...
		<img alt="Humidity. A Payload Map. Made by: Toolbox 24"src="/cdn/assets/images/blogposts/118/humidity.jpg" class= "imageinslider">
	</div>
    <div>
		<a href="https://steamcommunity.com/sharedfiles/filedetails/?id=503939302" target="_blank" class="steamworkshoplogoweapons">
			<img src="/cdn/assets/images/seal_vote_on_steam_workshop.svg">
		</a>
		<img alt="Overgrown. A Control Point (Attack/Defend) Map. Made by: UEAKCrash and PearForceOne"src="/cdn/assets/images/blogposts/118/overgrown.jpg" class= "imageinslider">
	</div>
    <div>
		<a href="https://steamcommunity.com/sharedfiles/filedetails/?id=2424608178" target="_blank" class="steamworkshoplogoweapons">
			<img src="/cdn/assets/images/seal_vote_on_steam_workshop.svg">
		</a>
		<img alt="Gorge: Reborn. A Control Point (Attack/Defend) Map. Made by: Bill Shit and qualitycont"src="/cdn/assets/images/blogposts/118/gorgereborn.jpg" class= "imageinslider">
	</div>
    <div>
		<a href="https://steamcommunity.com/sharedfiles/filedetails/?id=2404226979" target="_blank" class="steamworkshoplogoweapons">
			<img src="/cdn/assets/images/seal_vote_on_steam_workshop.svg">
		</a>
		<img alt="Sharkbay. A King of the Hill Map. Made by: Billo, Krazy, and Zeus"src="/cdn/assets/images/blogposts/118/sharkbay.jpg" class= "imageinslider">
	</div>
</div>
</div>
...
<div class="wrapper" id="cosmetics">
	<div image-carousel id="slider">
		<div>
			<img alt="Medic cosmetics."src="/cdn/assets/images/blogposts/118/medic_hats_SHOWCASE1.jpg" class= "imageinslider">
		</div>
		<div>
			<img alt="Multiclass cosmetics."src="/cdn/assets/images/blogposts/118/multicalss_hats_SHOWCASE1.jpg" class= "imageinslider">
		</div>
		<div>
			<img alt="Demo cosmetics."src="/cdn/assets/images/blogposts/118/demo_hats_SHOWCASE1.jpg" class= "imageinslider">
		</div>
		<div>
			<img alt="Allclass cosmetics."src="/cdn/assets/images/blogposts/118/allclass_hats_SHOWCASE1.jpg" class= "imageinslider">
		</div>
		<div>
			<img alt="Soldier cosmetics."src="/cdn/assets/images/blogposts/118/soldier_hats_SHOWCASE1.jpg" class= "imageinslider">
		</div>
	</div>
	</div>
